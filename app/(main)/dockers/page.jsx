                                    ...
                                    <div className={'grid'}>
                                        <div className={'col-6'}>
                                            <div className="flex flex-column gap-2">
                                                ...
                                                <InputText value={projectDirectory} disabled={true} className={'w-full'} placeholder={'There is no project directory configured.'} />
                                            </div>
                                        </div>
                                        <div className={'col-6'}>
                                            <div className="flex flex-column gap-2">
                                        ...
                                        <div className={'col-12 lg:col-6'}>
                                            <div className="flex flex-column gap-2">
                                                <label htmlFor="CONTAINER_NAME" className={'text-sm'}>
                                                    Container
                                                </label>
                                                <InputText
                                                    id={'CONTAINER_NAME'}
