        ...
        <div className="grid fadeIn">
                ...
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl font-bold">{isConnected ? data?.length ?? 0 : 'Disconnected'}</div>
                        </div>
                        <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
            ...
            {(data ?? []).length > 0 ? (
                            ...
                            <div className="card">
                                ...
                                <div className={'grid'}>
                                    <div className="col-12 lg:col-6 xl:col-3">
                                        <div className="card mb-0">
                                            <div data-pr-tooltip="The interface name type is a label assigned to a network interface that indicates its type and sequence on a device." className="tooltip flex justify-content-between mb-3">
                                                <div>
                                                    <span className="block text-500 font-medium mb-3">Name</span>
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.name ?? 'Unknown'}</div>
                                                </div>
                                                <div className="name flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                        ...
                                        <div className="card mb-0">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.macAddress ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                        ...
                                        <div className="card mb-0">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.maximumTransmissionUnit?.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                        ...
                                        <div className="card mb-0">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.bytesSent.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                        ...
                                        <div className="card mb-0">
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.bytesReceived.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    ...
                                    <div className="col-12 lg:col-6 xl:col-3">
                                        <div className="card mb-0">
                                            <div data-pr-tooltip="Network speed is the rate of data transfer over a network connection, measured in bits per second (bps)." className="tooltip flex justify-content-between mb-3">
                                                <div>
                                                    <span className="block text-500 font-medium mb-3">Network Speed</span>
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.speedBits.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    ...
                                    <div className="col-12 lg:col-6 xl:col-3">
                                        <div className="card mb-0">
                                            <div data-pr-tooltip="Packets sent refers to the number of data packets transmitted from a source device to a destination device over a network." className="tooltip flex justify-content-between mb-3">
                                                <div>
                                                    <span className="block text-500 font-medium mb-3">Packets Sent</span>
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.packetsSent?.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    ...
                                    <div className="col-12 lg:col-6 xl:col-3">
                                        <div className="card mb-0">
                                            ...
                                            >
                                                <div>
                                                    <span className="block text-500 font-medium mb-3">Packets Received</span>
                                                    <div className={'text-900 font-medium text-xl ' + (d?.isUp ? 'text-green-600' : 'text-red-600 animate-pulse')}>{d?.packetsReceived?.toLocaleString() ?? 'Unknown'}</div>
                                                </div>
                                                <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                                    ...
                                    <div className="col-12 lg:col-6">
                                        <div className="card mb-0 h-full">
                                            <DataTable
                                                ...
                                                size={'small'}
                                                removableSort
                                                value={isConnected ? d?.ipv4Addresses : []}
                                    ...
                                    <div className="col-12 lg:col-6">
                                        <div className="card mb-0 h-full">
                                            <DataTable
                                                ...
                                                size={'small'}
                                                removableSort
                                                value={isConnected ? d?.ipv6Addresses : []}
                ...
                <div className={'col-12'}>
                    <div className="card">
                        <Loader message={isConnected ? 'Requesting resources' : 'Connecting to backend'} />
                    </div>
                </div>
            )}
        </div>
